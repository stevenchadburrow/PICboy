...
DMG games run at 60 FPS on a PIC32MZ running at 260 MHz, as do some GBC/DX games.  Some GBC games need the framerate reduced to 20 FPS to let them run at full speed.<br>
